	...
	if (filefd == -1) { // return 404
		...
		ev->length = sprintf(ev->buffer, 
			"HTTP/1.1 404 Not Found\r\n"
		 	...
		 	"Content-Type: text/html;charset=ISO-8859-1\r\n"
			"Content-Length: 85\r\n\r\n"
		 	"<html><head><title>404 Not Found</title></head><body><H1>eeeee</H1></body></html>\r\n\r\n" );
 ////// http://192.168.125.128:8888/ 
	} else {
		...
		if (S_ISDIR(stat_buf.st_mode)) {
			...
			ev->length = sprintf(ev->buffer, 
				...
				"Content-Type: text/html;charset=ISO-8859-1\r\n"
				"Content-Length: 85\r\n\r\n"
				"<html><head><title>404 Not Found</title></head><body><H1>pppp</H1></body></html>\r\n\r\n" );
